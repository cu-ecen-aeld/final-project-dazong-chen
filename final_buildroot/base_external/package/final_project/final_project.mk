...
FINAL_PROJECT_VERSION = 6901bc5d4c7e99af32aae329ab2837bf5f6a4e9a
...
define FINAL_PROJECT_INSTALL_TARGET_CMDS
	$(INSTALL) -m 0755 $(@D)/final_application/client $(TARGET_DIR)/usr/bin
	$(INSTALL) -m 0755 $(@D)/final_application/server $(TARGET_DIR)/usr/bin
endef
